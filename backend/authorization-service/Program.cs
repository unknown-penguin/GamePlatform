...
builder.WebHost.ConfigureKestrel(options =>
{
    ...
    if (builder.Environment.IsProduction())
        options.ListenAnyIP(7047, listenOptions => listenOptions.UseHttps("/app/certificate.pfx", "365281")); // HTTPS
    if (builder.Environment.IsDevelopment())
        options.ListenLocalhost(7047, listenOptions => listenOptions.UseHttps("E:\\project\\GamePlatform\\certificate.pfx", "365281")); // HTTPS
});
